...
namespace Conference
{
    static class BD
    {
        static ConferenceEntities db = new ConferenceEntities();
        ...
        public static void EditUser(int userId, string newSurname, string newName, string newLastName, string newPhone, string newMail, string aboutYourSelf)
        {
            try
            {
                var user = (from u in db.users
        ...
        public static void EditUserPass(int userId, string newPass)
        {
            try
            {
                var user = (from u in db.users
        ...
        public static bool CheckPass(int userId, string pass)
        {
